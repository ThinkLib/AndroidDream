package com.madreain.androiddream.library.CommonPullToRefresh;
...
import com.madreain.androiddream.library.CommonPullToRefresh.indicator.PtrIndicator;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.DefaultLoadMoreViewFooter;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.GridViewHandler;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.ILoadMoreViewFactory;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.ListViewHandler;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.LoadMoreHandler;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.OnLoadMoreListener;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.OnScrollBottomListener;
import com.madreain.androiddream.library.CommonPullToRefresh.loadmore.RecyclerViewHandler;
import com.madreain.androiddream.library.CommonPullToRefresh.utils.PtrCLog;
...
//            显示已经加载完成，没有更多数据的布局
            mLoadMoreView.showFinishmore();
        }
    }
    /***
     * @加载更多时，网络异常
     */
    public void setNetworkAnomalyFinish(){
        //设置加载到底的时候 反弹回来
        setLoadMoreEnable(false);
        //设置已加载完毕
        loadMoreComplete(false);
        if (!isLoadingMore()) {
            setLoadMoreEnable(true);
//            显示已经加载完成，没有更多数据的布局
            mLoadMoreView.showNetWorkError();
        }
    }
